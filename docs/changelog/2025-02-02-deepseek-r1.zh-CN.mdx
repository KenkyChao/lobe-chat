...
description: NaiYunHub 现已支持 DeepSeek R1 并实时展示推理过程，让复杂问题的求解过程更加透明、易于理解。
tags:
  - DeepSeek R1
  - CoT
  - 思维链
...
NaiYunHub v1.49.12 已在社区版与 Cloud 版完整接入 DeepSeek R1。这次集成将模型的推理过程完整呈现，让你可以一步步跟进复杂问题是如何被拆解和解决的。
...
1. 升级至 NaiYunHub v1.49.12 或访问 [NaiYunHub.com](https://www.naiyun.com)
