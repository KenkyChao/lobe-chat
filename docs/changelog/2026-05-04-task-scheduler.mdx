...
description: >-
  Delegate Claude Code and Codex from inside NaiYunHub, with a redesigned home, a
...
Now you can control coding agents in NaiYunHub. Simply click `Create Agent` and choose your coding agent. This feature is only available on desktop app.
