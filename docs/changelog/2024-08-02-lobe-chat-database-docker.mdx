---
title: NaiYunHub Database Docker Image Official Release
description: >-
  NaiYunHub v1.8.0 ships the official database Docker image, completing the
...
# NaiYunHub Database Docker Image: The Final Piece of the Cloud Deployment Puzzle

With NaiYunHub v1.8.0, the official database Docker image is now available. This completes the server-side deployment path we have been building, so teams can run a full cloud deployment without gaps in their setup flow.
...
Visit the [official documentation](https://www.naiyun.com) to start deploying your own NaiYunHub service.
