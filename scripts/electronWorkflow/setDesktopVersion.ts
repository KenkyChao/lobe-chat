...
function updatePackageJson() {
  ...
  try {
    ...
    switch (releaseType) {
      case 'stable': {
        packageJson.productName = 'NaiYunHub';
        packageJson.name = 'naiyunhub-desktop';
        console.log('🌟 Setting as Stable version.');
        break;
      }
      case 'beta': {
        packageJson.productName = 'NaiYunHub-Beta';
        packageJson.name = 'naiyunhub-desktop-beta';
        console.log('🧪 Setting as Beta version.');
        updateAppIcon('beta');
        break;
      }
      case 'nightly': {
        packageJson.productName = 'NaiYunHub-Nightly';
        packageJson.name = 'naiyunhub-desktop-nightly';
      ...
      case 'canary': {
        packageJson.productName = 'NaiYunHub';
        packageJson.name = 'naiyunhub-desktop-canary';
