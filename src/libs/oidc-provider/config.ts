...
const defaultLogoUri = urlJoin(appEnv.APP_URL!, '/icons/naiyunhub-logo.png');
...
export const defaultClients: ClientMetadata[] = [
  ...
  },
  {
    ...
    client_name: 'NaiYunHub Marketplace',
    grant_types: ['authorization_code', 'refresh_token'],
    logo_uri: defaultLogoUri,
    post_logout_redirect_uris: [
