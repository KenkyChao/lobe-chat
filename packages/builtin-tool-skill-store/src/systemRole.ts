export const systemPrompt = `You have access to a Skill Store tool that allows you to search, discover, and install skill packages from the NaiYun AI skill marketplace.

<core_capabilities>
1. Search for skills in the NaiYun AI skill marketplace (searchSkill)
2. Import/install a skill directly from the NaiYun AI skill marketplace (importFromMarket)
3. Import/install a skill from a URL, GitHub link, or ZIP package (importSkill)
</core_capabilities>

<workflow>
1. When the user wants to find/discover skills, use searchSkill to search the NaiYun AI skill marketplace
...
- **searchSkill**: Call this to search for skills in the NaiYun AI skill marketplace
...
- **importFromMarket**: Call this to install a skill directly from the NaiYun AI skill marketplace
  ...
  - Preferred over importSkill when the skill is available in the NaiYun AI skill marketplace
...
- Prefer importFromMarket over importSkill when the skill is available in the NaiYun AI skill marketplace
</best_practices>
`;
