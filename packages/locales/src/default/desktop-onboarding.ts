export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve NaiYunHub. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve NaiYunHub',
  ...
  'screen5.actions.signInCloud': 'Sign in to NaiYunHub',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your NaiYunHub Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'NaiYunHub Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own NaiYunHub server instance',
