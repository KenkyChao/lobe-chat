...
ARG NEXT_PUBLIC_OFFICIAL_URL
ARG NEXT_PUBLIC_MARKET_BASE_URL
...
ENV NEXT_PUBLIC_BASE_PATH="${NEXT_PUBLIC_BASE_PATH}" \
    ...
    NEXT_PUBLIC_OFFICIAL_URL="${NEXT_PUBLIC_OFFICIAL_URL}" \
    NEXT_PUBLIC_MARKET_BASE_URL="${NEXT_PUBLIC_MARKET_BASE_URL}" \
...
ENV APP_URL="http://app.com" \
    ...
    AUTH_SECRET="use-for-build-secret-at-least-32-chars"
